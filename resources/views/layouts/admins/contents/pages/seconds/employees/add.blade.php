    ...
    <div class="tpl-portlet-components">
        <div class="portlet-title">
            <div class="caption font-green bold">
                <span class="am-icon-user-plus"></span>&nbsp;添加招聘
            </div>
        </div>
        <div class="tpl-block">
            <div class="am-g">
                <div class="tpl-form-body tpl-form-line">
                    {{Form::open(['url'=>url('admin/page-setting/employee/add'),'method'=>'post','class'=>'am-form tpl-form-line-form','files'=>true])}}
                        ...
                        <div class="am-form-group">
                            {{Form::label('content','#&nbsp;招聘内容',['class'=>'am-u-sm-3 am-form-label'])}}
                            <div class="am-u-sm-9">
