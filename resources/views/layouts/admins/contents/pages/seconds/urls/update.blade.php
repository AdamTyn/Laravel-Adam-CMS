        ...
        <div class="tpl-block">
            <div class="am-g">
                <div class="tpl-form-body tpl-form-line">
                    {{Form::open(['url'=>url('admin/page-setting/urls/update'.'/'.$urls['id']),'method'=>'post','class'=>'am-form tpl-form-line-form','files'=>true])}}
                        <div class="am-form-group">
                            {{Form::label('title','#&nbsp;友商名称',['class'=>'am-u-sm-3 am-form-label'])}}
                            <div class="am-u-sm-9">
                                {{Form::text('title',$urls['title'],['class'=>'tpl-form-input','placeholder'=>'请输入名称'])}}
                            ...
                            <div class="am-u-sm-9">
                                <div class="am-form-group am-form-file">
                                    <div class="tpl-form-file-img">
                                        {{Html::image(asset($urls['picture']),'',['id'=>'picture'])}}
                                        <small><span style="color:blue;" id="picture-span">{{substr($urls['picture'],7)}}</span></small>
                                    </div>
