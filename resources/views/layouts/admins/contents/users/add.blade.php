        ...
        <div class="tpl-block ">
            <div class="am-g tpl-amazeui-form">
                <div class="am-u-sm-12 am-u-md-9">
                    {{Form::open(['url'=>url('admin/user-setting/add/insert'),'method'=>'post','class'=>'am-form am-form-horizontal'])}}
                        <div class="am-form-group">
                            <label for="user-name" class="am-u-sm-3 am-form-label">#&nbsp;管理员名</label>
                            <div class="am-u-sm-9">
                                {{Form::text('name','',['id'=>'user-name','placeholder'=>'输入管理员名'])}}
                            </div>
                        </div>
                        <div class="am-form-group">
                            <label for="user-email" class="am-u-sm-3 am-form-label">#&nbsp;电子邮件</label>
                            <div class="am-u-sm-9">
                                {{Form::text('email','',['placeholder'=>'输入电子邮件','id'=>'user-email'])}}
                            </div>
                        </div>
                        ...
                        <div class="am-form-group">
                            <div class="am-u-sm-9 am-u-sm-push-3">
                                {{Form::submit('确认添加',['class'=>'am-btn am-btn-primary','type'=>'button'])}}
                            </div>
                        </div>
                    {{Form::close()}}
                </div>
