...
@section('slider')
@include('layouts.admins.sliders.pages.page')
@endsection
@section('content')
@include('layouts.admins.contents.pages.page')
@endsection
@section('script')
...
&nbsp;&nbsp;{{$errors['title']}}</span>
    ...
    <div class="am-modal-bd">
        <span id='content'><strong>'{{$errors['content']}}'</strong>&nbsp;&nbsp;页面已经修改</span>
    </div>
...
<script type="text/javascript">
   $('.page-select').change(function() {
    var val = $(this).val();
    var url='{{url('admin/page-setting/page')}}';
    var asset='{{asset('')}}';
    switch(val){
        case 'service':
        $('#div-top-title').hide();
