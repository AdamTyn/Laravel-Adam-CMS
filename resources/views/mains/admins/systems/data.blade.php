...
@section('slider')
@include('layouts.admins.sliders.systems.data')
@endsection
@section('content')
@include('layouts.admins.contents.systems.data')
@endsection
@section('script')
@include('layouts.admins.script')
{{Html::script(asset('js/echarts.js'))}}
...
$(function() {
	$.get('{{ url('admin/system/getData') }}',{},function(back){
