        ...
        <div class="tpl-block">
            <div class="am-g">
                <div class="tpl-form-body tpl-form-line">
                    <?php echo e(Form::open(['url'=>url('admin/page-setting/news/update'.'/'.$news['id']),'method'=>'post','class'=>'am-form tpl-form-line-form','files'=>true])); ?>

                        <div class="am-form-group">
                            <?php echo e(Form::label('title','#&nbsp;动态标题',['class'=>'am-u-sm-3 am-form-label'])); ?>

                            <div class="am-u-sm-9">
                                <?php echo e(Form::text('title',$news['title'],['class'=>'tpl-form-input','placeholder'=>'请输入标题'])); ?>
                            ...
                            <div class="am-u-sm-9">
                                <div class="am-form-group am-form-file">
                                    <div class="tpl-form-file-img">
                                        <?php echo e(Html::image(asset($news['picture']),'',['id'=>'picture'])); ?>

                                        <small><span style="color:blue;" id="picture-span"><?php echo e(substr($news['picture'],7)); ?></span></small>
                                    </div>
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                <?php echo e(Form::textarea('content',ToTextarea($news['content'],true),['rows'=>8])); ?>
