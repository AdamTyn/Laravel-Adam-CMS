    ...
    <div class="tpl-portlet-components">
        <div class="portlet-title">
            <div class="caption font-green bold">
                <span class="am-icon-refresh"></span>&nbsp;动态列表
            </div>
        </div>
        <div class="tpl-block">
            <div class="am-g">
            ...
            <div class="am-g">
                <div class="am-u-sm-12">
                    <form class="am-form" id="form">
                        ...
                        <tbody>
<?php $__currentLoopData = $news; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
<tr>
    ...
    <td>
        <a href="<?php echo e(url('admin/page-setting/news/update').'/'.$value['id']); ?>"><?php echo e(StrShort(ToTextarea($value['detail']),0,100)); ?></a>
    </td>
    <td class="am-hide-sm-only">
...
<script type="text/javascript">
    $('.btn-edit').click(function(){
        ...
        $('#form').attr('action','<?php echo e(url('admin/page-setting/news/update')); ?>'+'/'+ids[1]);
    });
    $('.btn-delete').click(function(){
        var ids=this.id.split('-');
        $('#form').attr('action','<?php echo e(url('admin/page-setting/news/delete')); ?>'+'/'+ids[1]);
    });
</script>
</div>
</div>
