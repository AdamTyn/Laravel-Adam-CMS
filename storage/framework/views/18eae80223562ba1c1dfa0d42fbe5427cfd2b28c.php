<div class="tpl-content-wrapper">
    ...
    <ol class="am-breadcrumb">
        ...
        <li class="am-active"><a href="<?php echo e(url('admin/user-setting/list')); ?>">列表</a></li>
        ...
        <div class="tpl-block ">
            <div class="am-g tpl-amazeui-form">
                <div class="am-u-sm-12 am-u-md-9">
                    <?php echo e(Form::open(['url'=>url('admin/user-setting/list/update').'/'.$user['id'],'method'=>'post','class'=>'am-form am-form-horizontal'])); ?>

                        <div class="am-form-group">
                            <label for="user-name" class="am-u-sm-3 am-form-label">#&nbsp;管理员名:</label>
                            <div class="am-u-sm-9">
                                <?php echo e(Form::text('name','',['id'=>'user-name','placeholder'=>$user['name']])); ?>
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                <?php echo e(Form::text('email','',['placeholder'=>$user['email'],'id'=>'user-email'])); ?>
                        ...
                        <div class="am-form-group">
                            <div class="am-u-sm-9 am-u-sm-push-3">
                                <?php echo e(Form::submit('确认修改',['class'=>'am-btn am-btn-primary','type'=>'button'])); ?>
